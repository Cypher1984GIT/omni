...
| OS | Link |
| :--- | :--- |
| **Windows** | [Download .exe](https://github.com/Cypher1984GIT/omni/releases/download/v1.2.3/Omni-Setup-1.2.3.exe) |
| **Linux** | [Download .AppImage](https://github.com/Cypher1984GIT/omni/releases/download/v1.2.3/Omni-1.2.3.AppImage) |
