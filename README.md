...
| OS | Link |
| :--- | :--- |
| **Windows** | [Download .exe](https://github.com/Cypher1984GIT/omni/releases/download/v1.0.3/Omni-1.0.3.AppImage) |
| **Linux** | [Download .AppImage](https://github.com/Cypher1984GIT/omni/releases/download/v1.0.3/Omni.Setup.1.0.3.exe) |
